    ...
    <header className="bg-white py-3 px-4 shadow-sm">
      ...
      {isMobile && (
        <div className="flex items-center mb-3 gap-2 w-full">
          {/* State dropdown - narrower */}
          <div className="relative w-24">
            <button
              onClick={toggleStateDropdown}
              className="flex items-center justify-between w-full px-3 py-2 border border-gray-200 rounded-md"
            >
          ...
          {/* Search input - wider with separate search button */}
      ...
      <div className="container flex items-center justify-between">
        ...
        {/* Sell Button */}
        <div className={isMobile ? "order-3" : ""}>
          <button className="bg-secondary  text-white px-8 py-2 rounded flex items-center text-sm md:text-base md:px-4">
