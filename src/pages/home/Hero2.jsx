...
import hero4 from "../../assets/images/banner.jpg";
import hero5 from "../../assets/images/banner2.jpg";
...
const Hero2 = () => {
  ...
  const slides = [{ image: hero1 }, { image: hero2 }, { image: hero3 }, { image: hero4 }, { image: hero5 }];
  ...
  return (
    <div className="relative overflow-hidden rounded-[4px] w-full">
      {/* Image Carousel */}
      <div className={`relative ${isMobile ? "h-[250px] w-[450px]" : "h-[500px]"}`}>
