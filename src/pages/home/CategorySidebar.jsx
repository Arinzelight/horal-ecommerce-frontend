...
export default function Sidebar() {
  ...
  if (isMobile) {
    return (
      <div className=" lg:max-w-5xl lg:mx-auto lg:px-12 my-4  relative">
  ...
  // Desktop view
  return (
    <div className="w-full rounded-md h-[500px] bg-primary text-white p-3 scrollbar-hide overflow-y-auto hidden md:block lg:block ">
...
//   // Desktop view
//   return (
//     <div className="w-full h-[500px] bg-primary text-white p-4 overflow-y-auto">
