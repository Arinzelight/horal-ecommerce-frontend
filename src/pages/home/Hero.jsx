          ...
          <div className="max-w-lg w-full text-center md:text-left mb-6 md:mb-0 transition-all duration-700 ease-in-out">
            ...
            <Link to="/category/gadget ">
              <div className="flex justify-center md:justify-start">
                <button className="px-5 py-2 cursor-pointer sm:px-6 sm:py-3 bg-banner-orange text-white rounded-sm font-semibold hover:opacity-90 transition font-vivendi text-sm sm:text-base flex items-center gap-2">
                  {banner.btn}
