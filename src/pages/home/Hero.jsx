      ...
      {banners.map((banner, index) => (
        <div
          ...
          className={`
            ...
            lg:px-14 md:px-6 px-3 sm:py-6 py-4 transition-opacity duration-700 ease-in-out
        ...
        >
          ...
          <div className="max-w-lg w-full text-center md:text-left mb-6 md:mb-0 transition-all duration-700 ease-in-out">
            <div className="flex sm:gap-2 gap-1 items-center justify-center md:justify-start">
              <div
            ...
            <Link to="/category/gadget ">
              <div className="flex justify-center md:justify-start">
                <button className="sm:px-8 px-4 cursor-pointer py-2.5  sm:py-4 bg-banner-orange text-white rounded-sm font-semibold hover:opacity-90 transition font-vivendi text-base flex items-center gap-2">
                  {banner.btn}
