...
function OrderDetails() {
  ...
  return (
    <div className="py-10 flex flex-col gap-5">
      ...
      <Link
        to="/profile-page/order-history"
        className="w-full h-14 hover:opacity-95 hover:cursor-pointer text-white md:text-xl text-base font-semibold md:font-bold px-10 bg-secondary rounded-lg flex justify-center items-center gap-3 overflow-hidden"
      >
        Go To My Order
      </Link>
      <Link
        to="/products"
        className="w-full text-neutral-900 hover:cursor-pointer text-base md:text-xl font-semibold md:font-bold h-14 px-10 rounded-lg outline outline-1 outline-offset-[-1px] outline-neutral-400 flex justify-center items-center gap-3 overflow-hidden"
      >
        Continue Shopping
      </Link>
