export const specificationsByCategory = {
  ...
  "health and beauty": [
    ...
    {
      key: "weight",
      label: "Weight/Net Content",
      placeholder: "e.g., 50ml, 100g",
    },
    { key: "volume", label: "Volume", placeholder: "e.g., 250ml" },
    { key: "shelf_life", label: "Shelf Life", placeholder: "e.g., 24 months" },
    {
      key: "shade",
      label: "Shade/Color",
  ...
  accessories: [
    { key: "dimensions", label: "Dimensions", placeholder: "e.g., 20 x 15 cm" },
    ...
    },
    {
      ...
      placeholder: "How to maintain the product",
    },
  ],
  children: [
    {
    ...
    { key: "weight", label: "Weight", placeholder: "e.g., 1kg" },
    {
      key: "material",
      label: "Material",
  ...
  vehicles: [
    ...
    { key: "fuel_capacity", label: "Fuel Capacity", placeholder: "e.g., 45L" },
    {
      key: "transmission",
      label: "Transmission",
